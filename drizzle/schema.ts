...
}, table => [index("workspace_files_user_created_idx").on(table.userId, table.createdAt), index("workspace_files_session_created_idx").on(table.sessionId, table.createdAt)]);
...
}, table => [index("workspace_results_user_created_idx").on(table.userId, table.createdAt), index("workspace_results_session_created_idx").on(table.sessionId, table.createdAt)]);
